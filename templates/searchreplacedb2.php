<!DOCTYPE html>
<html xmlns="" xmlns:dc="" dir="ltr" lang="en-US">
...
<body>
	...
	<p class="byline">by interconnect/<strong>it</strong></p>
		...
		<form action="searchreplacedb2.php?step=3" method="post">
			...
			<h4><a href="#">#</a> <a href="#">Safe Search and Replace on Database with Serialized Data v2.0.0</a></h4>
			...
			<p><a href="#">Got feedback on this script? Come tell us!</a>
		</div>
	</div>
</body>
</html>